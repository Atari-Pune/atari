...
const customPortalSidebarItems = [
    { label: 'Home', path: '/' },
    { label: 'ATARI KVKs In ICAR News', path: '/atari-kvks-in-icar-news' },
];
...
const portalBreadcrumbs = [
    { label: 'Home', path: '/' },
    { label: 'ATARI KVKs In ICAR News' } // Current page, no path for last item
];

/**
 * Component for the Portal page.
 */
const ATARIKVKsInICARNews = () => {
    return (
        <CommonLayout
            pageTitle="ATARI KVKs In ICAR News" // REQUIRED page title for the Portal page
            ...
            sidebarTitle="ATARI KVKs In ICAR News" // Custom sidebar title, consistent with Important Links
        >
            <Box sx={{ mb: 2 }}>
...
export default ATARIKVKsInICARNews;