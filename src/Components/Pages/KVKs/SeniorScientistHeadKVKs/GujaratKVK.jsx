      ...
      <Box sx={{ mb: 2 }}>
        ...
        <Box sx={{ mt: 3, p: 2, border: '1px dashed #ccc', textAlign: 'center', minHeight: '200px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#f0f0f0' }}>
          <Typography variant="body1" color="text.secondary">
           <embed src="https://ik.imagekit.io/ataripune/assets/Contact%20Details/KVK%20Heads%20contact%20%20/Gujarat%20KVK%20%20Sr%20Scientist%20&%20head%20list-09.07.2025.pdf?updatedAt=1753943181392" width="600" height="500" type="application/pdf"/>
          </Typography>
        </Box>
      </Box>
    </Commonpage>
