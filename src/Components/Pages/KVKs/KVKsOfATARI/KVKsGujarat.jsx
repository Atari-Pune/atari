...
const KVKsGujarat = () => {
  return (
    ...
    <Commonpage>
      ...
      <embed src="https://ik.imagekit.io/ataripune/assets/Contact%20Details/KVKs%20in%20ATARI/KVKs%20in%20Gujarat.pdf?updatedAt=1753943074114" width="600" height="500" type="application/pdf"/>
          </Typography>
        </Box>
      </Box>
    </Commonpage>
