...
const kvkData = [

  {
    ...
    color: '#D1C4E9',
    kvks: [
      { name: 'Solapur-II', url: 'https://www.kvksolapur.org/' },
      { name: 'Dhule', url: 'https://kvkdhule.org/' },
      { name: 'Jalgaon-II', url: 'https://www.kvkjalgaon.org/' },
      { name: 'Satara-II', url: 'https://kvksatara2.in' },
    ],
  },
  ...
  },
  {
    ...
    color: '#FFE0B2',
    kvks: [
      { name: 'Raigad', url: 'https://kvkraigad.in' },
      { name: 'Ratnagiri', url: 'http://www.kvkratnagiri.org/' },
    ],
  },
  ...
  },
  {
    ...
    color: '#FFECB3',
    kvks: [
      { name: 'Bhandara', url: 'https://www.pdkv.ac.in/' },
      { name: 'Wardha', url: 'https://kvkselsura.pdkv.ac.in/' },
      { name: 'Buldhana-II', url: 'https://kvkbuldhana2.in' },
      { name: 'Chandrapur', url: 'https://kvkchandrapur.in' },
      { name: 'Gadchiroli', url: 'https://kvkgadchiroli.in' },
      { name: 'Gondia', url: 'https://kvkgondia.in' },
      { name: 'Yavatmal-I', url: 'https://kvkyavatmal1.in' },
    ],
  },

  {
    ...
    kvks: [
      ...
      { name: 'Aurangabad-I', url: 'https://kvkaurangabad1.in' },
  ...
  },
  {
    ...
    color: '#FFE0B2',
    kvks: [
      { name: 'Nashik-I', url: 'https://www.kvknashik.org/' },
    ],
  },
