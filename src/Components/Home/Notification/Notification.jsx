    ...
    },
{
      ...
      text: "Review Workshop of ARYA"
    },


     {
      id: 1,
      link: "https://ik.imagekit.io/ataripune/assets/document/pdf/Recent%20Events/Report%20on%20Viksit%20Krishi%20Sankalp%20Abhiyan.pdf?updatedAt=1759135156706",
      text: "Viksit Krishi Sankalp Abhiyan- Pre-Kharif 2025 "
     }
        ...
        >
          ...
          <marquee ref={marqueeRef} scrollamount="10" behavior="scroll" direction="left">
            <Box sx={{ display: 'inline-flex', alignItems: 'center' }}>
              {/* change the endlessEventAlerts to eventAlerts to stop the duplication */}
              {eventAlerts.map((event, index) => (
